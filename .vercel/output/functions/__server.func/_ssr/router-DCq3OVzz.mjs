...
const appCss = "/assets/styles-RtuM0LLR.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,200..800&family=Hanken+Grotesk:wght@400;500;600;700;800;900&family=Geist+Mono:wght@400;500;600;700&display=swap"
      }
    ]
  }),
...
const $$splitComponentImporter = () => import("./index-ttk-8fr6.mjs");
...
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      property: "og:image",
      content: "https://tappedin.site/og.png"
    }, {
      ...
      content: "tappd in. the fitness app that shows its work."
    }, {
      name: "twitter:card",
