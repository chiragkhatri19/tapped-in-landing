...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B84qdWhg.mjs");
...
const manifest = {
  "5338d8458f92f0c0a4eb17982746ff1114500791b6ef7234bac0a3231a3950df": {
    functionName: "getWaitlistCount_createServerFn_handler",
    importer: () => import("./waitlist.functions-txsMq1Rn.mjs")
  },
  "b232b7d28df608ca66400bfe3954e980a68804a3e2aca52359abaab8e51da368": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DCq3OVzz.mjs"),
    import("./start-BE7DC802.mjs"),
